  ...
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        ...
        <p class="mt-3 text-black w-fit">Have questions about our mobile phones? We're here to help!</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Preferred Model</label>
        ...
        <div>
          <label class="font-medium text-black">Message</label>
          <textarea
            required
